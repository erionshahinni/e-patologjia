    ...
    <>
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500">Dr. {selectedDoctor}</p>
        </div>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Reports for Dr. {selectedDoctor}</CardDescription>
            </div>
            <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center flex-wrap gap-3">
                          ...
                          <span className={`flex items-center gap-1 text-sm ${isDoctorMain ? 'text-blue-600 font-medium' : 'text-gray-500'}`}>
                            <UserCircle className="h-4 w-4" />
                            {isDoctorMain ? 'Main Doctor' : 'Additional Doctor'}
                          </span>
                          <span className="flex items-center gap-1 text-sm text-gray-500">
                            <Building2 className="h-4 w-4" />
                            {report.healthcareInstitution || 'Unknown Institution'}
                          </span>
                        </div>
                        ...
                        {otherDoctors.length > 0 && (
                          <div className="mt-2 flex flex-wrap gap-1 text-xs text-gray-500">
                            <span className="text-xs text-gray-600">Other doctors:</span>
